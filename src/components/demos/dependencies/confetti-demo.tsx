...
//   const onParticlesChange = (event: { target: { value: string } }) => {
//     const newNumParticles = parseInt(event.target.value, 10);
//     setNumParticles(newNumParticles);
//   };
//   const onGravityChange = (event: { target: { value: string } }) =>
//     setGravity(parseFloat(event.target.value));
//   const onWindChange = (event: { target: { value: string } }) =>
//     setWind(parseFloat(event.target.value));
