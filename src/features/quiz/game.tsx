...
function convertDifficultyToPoints(difficulty: string) {
...
function Game({ triviaData }: IGameArgs) {
  ...
  const onAnswerSelected = (wasPlayerCorrect: boolean, difficulty: string) => {
